$(document).ready(function(){
    ...
    var interval = $("#imageMenu li:first").width() + 10;
    var curIndex = 0;
    ...
    $("#imageMenu li img").bind("mouseover", function(){
        if ($(this).attr("id") != "onlickImg") {
            midChange($(this).attr("src").replace("big", "big"));
            $("#imageMenu li").removeAttr("id");
            $("#imageMenu li img").removeAttr("style")
            $(this).parent().attr("id", "onlickImg");
            $(this).css({ "border": "3px solid #e14041" });
        }
    });
    ...
    function changeViewImg() {
        $("#bigView img").attr("src", $("#midimg").attr("src").replace("big", "big"));
    }
    changeViewImg();

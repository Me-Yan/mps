...
<script src="${pageContext.request.contextPath}/resources/plugins/fileinput/js/fileinput.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/plugins/fileinput/js/zh.js"></script>
